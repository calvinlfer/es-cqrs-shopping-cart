...
import com.experiments.shopping.cart.repositories.internal.{
  ...
  CassandraPopularItemsRepository
}
...
class AppDatabase private[repositories] (override val connector: CassandraConnection)
  ...
  protected object popularItems extends CassandraPopularItemsRepository with connector.Connector
  val readSide = new CassandraReadSideRepository(offsetTracking, popularItems) with connector.Connector
}
